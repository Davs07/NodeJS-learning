...
const ofertas = [
  {
    ...
    puesto: "Data Analyst",
    descripcion:
      "Buscamos un analista de datos con experiencia en análisis de grandes volúmenes de datos y habilidades en Python y SQL.",
...

  {
    ...
    descripcion:
      "Buscamos un desarrollador de software con experiencia en JavaScript y Python para unirse a nuestro equipo de desarrollo ágil.",
  ...
  },
  {
    ...
    descripcion:
      "Estamos buscando un ingeniero con experiencia en energías renovables para liderar proyectos de energía solar y eólica.",
  ...
  },
  {
    ...
    puesto: "Enfermero/a",
    descripcion:
      "Buscamos enfermeros dedicados y compasivos para trabajar en nuestra unidad de cuidados intensivos.",
  ...
  },
  {
    ...
    descripcion:
      "Estamos en busca de un analista de marketing que se encargue de desarrollar estrategias de mercado y analizar el comportamiento del consumidor.",
    experiencia: "3 años en análisis de marketing",
    educacion: "Licenciatura en Marketing o afines",
    jornada: "Tiempo completo",
    modalidad: "Híbrido",
    lugar_trabajo: "Cajamarca",
  ...
  },
  {
    ...
    descripcion:
      "Se requiere contador público con experiencia en auditoría y fiscalidad para unirse a nuestro equipo financiero.",
  ...
  },
  {
    ...
    descripcion:
      "Buscamos un desarrollador de contenidos educativos para crear materiales didácticos interactivos.",
  ...
  },
  {
    ...
    descripcion:
      "Estamos buscando un gerente de logística con experiencia en la industria marítima para optimizar nuestras operaciones de envío.",
    experiencia: "6 años en logística y operaciones",
    educacion: "Licenciatura en Administración de Empresas, Logística o afines",
    jornada: "Tiempo completo",
    modalidad: "Presencial",
    lugar_trabajo: "Lambayeque",
